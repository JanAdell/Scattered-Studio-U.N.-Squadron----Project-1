...
bool ModuleScene::Start()
{
	...
	*/
	...
	App->enemies->AddEnemy(ENEMY_TYPE::BIG_CAMO_JET, 500, 300);
	App->enemies->AddEnemy(ENEMY_TYPE::BIG_CAMO_JET, 500, 100);

	App->enemies->AddEnemy(ENEMY_TYPE::ORANGE_JET, -50, 100);
